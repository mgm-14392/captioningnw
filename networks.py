...
class VAE(nn.Module):
    ...
    def __init__(self, nc=15, ngf=128, ndf=128, latent_variable_size=512):
        ...
        #self.device = torch.device("cuda:0" if (torch.cuda.is_available() and use_cuda == True) else "cpu")
...
class DecoderRNN(nn.Module):
    ...
    def sample(self, features, states=None):
        ...
        for i in range(72):  # maximum sampling length
